...
<img src="https://github.com/QishengLiu/unbeatable-grade-hunters/raw/main/image/image.png" width="300" height="auto" />

## 2. 团队名称

我们团队的名称是**以太校园——多智能体驱动的校园信息整合平台**
...
- 选题背景与研究意义
  ...
  >
  > 基于此，本项目设计并实现一个**多智能体驱动的校园信息整合平台——AetherNet（以太校园）**，通过智能审核、语义匹配与任务撮合机制，构建可信、高效、自治的校园互助生态系统。
  >
  > 本研究的意义体现在以下三个方面：
  >
...
- 现阶段成果
  ...
  > 1. 一套可运行的校园互助系统（Web管理端 + 用户端微信小程序）；
  > 2. 完整的系统需求说明书（SRS）；
  > 3. AI辅助优化用户与管理端体验及推荐机制；
